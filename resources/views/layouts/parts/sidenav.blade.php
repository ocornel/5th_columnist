        ...
        <div class="custom-scrollbar">
            <nav id="sidenav" class="sidenav-collapse collapse">
                <ul class="sidenav level-1">
                    ...
                    <li class="sidenav-item has-subnav">
                        <a href="blank-page.html#multi-level-menu" aria-haspopup="true">
                            <span class="sidenav-icon icon icon-works">&#103;</span>
                        ...
                        <ul class="sidenav level-2 collapse">
                                ...
                                <ul class="sidenav level-3 collapse">
                                    <li class="sidenav-item has-subnav">
                                        ...
                                        <ul class="sidenav level-4 collapse">
                                            ...
                                            <li class="sidenav-item has-subnav">
                                                <a href="blank-page.html#top-locations">
                                            ...
                                            <li class="sidenav-item has-subnav">
                                                <a href="blank-page.html#top-referrals">
                                    ...
                                    <li class="sidenav-item">
                                        <a href="blank-page.html#traffic-sources">
                                            <span class="icon icon-works">&#213;</span>Traffic Sources
                                        </a>
                                    </li>
                                    <li class="sidenav-item">
                                        <a href="blank-page.html#events">
                            ...
                            <li class="sidenav-item">
                                <a href="blank-page.html#audience">
                                    <span class="icon icon-works">&#80;</span>Audience
                                </a>
                            </li>
                            <li class="sidenav-item">
                                <a href="blank-page.html#behavior">
                    ...
                    <li class="sidenav-item has-subnav">
                        ...
                        <ul class="sidenav level-2 collapse">
                            ...
                            <li class="sidenav-item has-subnav">
                                <a href="blank-page.html#real-time">Real-Time</a>
                                <ul class="sidenav level-3 collapse">
                                    <li class="sidenav-item has-subnav">
                                        <a href="blank-page.html#overview">Overview</a>
                                        <ul class="sidenav level-4 collapse">
                                            <li class="sidenav-item has-subnav">
                                                <a href="blank-page.html#top-keywords">Top Keywords</a>
                                                <ul class="sidenav level-5 collapse">
                                                    <li class="sidenav-item">
                                                        <a href="blank-page.html#past-24h">Past 24h</a>
                                                    </li>
                                                    <li class="sidenav-item">
                                                        <a href="blank-page.html#past-1wk">Past 1wk</a>
                                                    </li>
                                                    <li class="sidenav-item">
                                                        <a href="blank-page.html#past-1mo">Past 1mo</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="sidenav-item has-subnav">
                                                <a href="blank-page.html#top-locations">Top Locations</a>
                                                <ul class="sidenav level-5 collapse">
                                                    <li class="sidenav-item">
                                                        <a href="blank-page.html#past-24h">Past 24h</a>
                                                    </li>
                                            ...
                                            <li class="sidenav-item has-subnav">
                                                <a href="blank-page.html#top-referrals">Top Referrals</a>
                                                <ul class="sidenav level-5 collapse">
                                                    <li class="sidenav-item">
                                                        <a href="blank-page.html#past-24h">Past 24h</a>
                                                    </li>
                                    ...
                                    <li class="sidenav-item">
                                        <a href="blank-page.html#traffic-sources">Traffic Sources</a>
                                    </li>
                                    <li class="sidenav-item">
                                        <a href="blank-page.html#events">Events</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sidenav-item">
                                <a href="blank-page.html#audience">Audience</a>
                            </li>
                            <li class="sidenav-item">
                                <a href="blank-page.html#behavior">Behavior</a>
                            </li>
                        </ul>
                    </li>
